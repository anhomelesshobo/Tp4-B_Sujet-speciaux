...
namespace WeatherApp.ViewModels
{
    public class TemperatureViewModel : BaseViewModel
    {
        ...
        public bool CanGetTemp(string obj)
        {
            ...
            {
                RawText = "You need to set-up the ApiKey before loading some temperature!";
                return false;
        ...
        private async Task GetTempAsync()
        {
            ...
            TemperatureModel checkout = new TemperatureModel();
            checkout = await TemperatureService.GetTempAsync();

            if (checkout!= null)
            {
                CurrentTemp = checkout;
